...
import (
	...
	"github.com/launchboxio/cluster-api-provider-proxmox/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "9254012e.cluster.x-k8s.io",
	...
	if err = (&controllers.ProxmoxMachineReconciler{
	...
	if err = (&controllers.ProxmoxMachinePoolReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "ProxmoxMachinePool")
		os.Exit(1)
	}
