...
func (in *ProxmoxMachineStatus) DeepCopyInto(out *ProxmoxMachineStatus) {
	*out = *in
	...
	if in.Tasks != nil {
		...
		*out = make(map[string]*ProxmoxMachineTaskStatus, len(*in))
		for key, val := range *in {
			var outVal *ProxmoxMachineTaskStatus
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
				*out = new(ProxmoxMachineTaskStatus)
				**out = **in
			}
			(*out)[key] = outVal
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProxmoxMachineTaskStatus) DeepCopyInto(out *ProxmoxMachineTaskStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProxmoxMachineTaskStatus.
func (in *ProxmoxMachineTaskStatus) DeepCopy() *ProxmoxMachineTaskStatus {
	if in == nil {
		return nil
	}
	out := new(ProxmoxMachineTaskStatus)
