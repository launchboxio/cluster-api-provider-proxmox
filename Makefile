...
# cluster.x-k8s.io/cluster-api-provider-proxmox-bundle:$VERSION and cluster.x-k8s.io/cluster-api-provider-proxmox-catalog:$VERSION.
IMAGE_TAG_BASE ?= cluster.x-k8s.io/cluster-api-provider-proxmox
